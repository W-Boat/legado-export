...
object PreferKey {
    ...
    const val epubExportConfig = "epubExportConfig"
    const val epubCssMode = "epubCssMode"
    const val epubVersion = "epubVersion"
    const val epubExportLogo = "epubExportLogo"
    const val epubExportEmptyChapters = "epubExportEmptyChapters"
    const val epubEnableDuokanFullscreen = "epubEnableDuokanFullscreen"
